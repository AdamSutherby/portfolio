export default function About() {
    return (
        <div>
            <h1 className="text-4xl font-mono text-center mt-40">I am Adam Sutherby,</h1>
        <div className="flex flex-row mx-auto max-w-[60%] mt-10 justify-center">
            ...
            a passionate software and web application developer dedicated to creating impactful digital solutions. With a strong foundation in coding and a creative problem-solving approach, I specialize in building intuitive and efficient applications tailored to meet user needs. Driven by my love for innovation and continuous learning, I thrive in collaborative environments where I can contribute fresh ideas and work closely with teams to deliver exceptional results. I'm excited about the opportunity to apply my skills and contribute to meaningful projects. Let's connect and explore how we can work together to make a difference through technology! Currently looking for new opportunities.
            </p>
            <img
